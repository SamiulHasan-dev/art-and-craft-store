                ...
                <div className="navbar-end">
                    ...
                    {user ? (
                        <div className="flex items-center gap-3">
                            ...
                            <Link to="/login"><button onClick={handleSignOut} className="btn bg-orange-600 text-white md:ml-2">Log Out</button></Link>
                        </div>
                    ) : (
                        <div>
                            <Link to="/login"><button className="btn bg-orange-600 text-white md:mx-2">Login</button></Link>
                            <Link to="/register"><button className="btn bg-orange-600 text-white">Register</button></Link>
                        </div>
                    )}
                </div>
