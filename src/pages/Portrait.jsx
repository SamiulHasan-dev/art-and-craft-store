...
const Portrait = () => {
    ...
    useEffect(()=>{
        fetch('https://crafters-cove-server.vercel.app/portrait')
        .then(res => res.json())
    ...
    return (
        <div>
            <h2 className="text-3xl text-center font-bold py-5 bg-orange-400 rounded-lg mb-5 text-white">Portrait Drawing</h2>
